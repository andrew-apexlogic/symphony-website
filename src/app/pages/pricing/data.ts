...
type PlanType = {
  ...
  audition?: boolean | string
  performer?: boolean | string
  feature: FeatureType
}
...
export const planData: ComparePlanType[] = [
  {
    title: 'All Symphony Licenses Include:',
    children: [
      {
        feature: {
      ...
      {
        feature: {
          name: 'Contract Vehicle On-Ramping',
          // info: 'Feature description text',
        },
       audition: false,
      //  performer: true
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        audition: '2 Hour Response Time 12 x 5'
      },
      {
        feature: {
        ...
        audition: 'Quarterly (Webinar)'
      },
      {
        feature: {
          name: 'Contract Holder Training',
          // info: 'Feature description text',
        },
        audition: 'Quarterly (Webinar)'
      },
